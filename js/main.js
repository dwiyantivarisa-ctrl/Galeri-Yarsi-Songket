...
const gallerySlider = function() {
    ...
    const gSlider = document.querySelector('.gallery-slider');
    if (!(gSlider)) return;

    const slider = new Swiper(gSlider, {
        slidesPerView: 1,
        loop: true,
        pagination: {
...
function openBio(role) {
    const data = {
        owner: {
            name: "Yarsi Novita",
            role: "Founder & Owner",
            desc: "Merintis usaha songket sejak tahun 2000, berkomitmen menjaga kualitas dan nilai budaya Minangkabau."
        },
        design: {
            name: "Nama Desainer",
            role: "Creative Design",
            desc: "Bertanggung jawab atas konsep visual dan estetika brand."
        },
        marketing: {
            name: "Nama Marketing",
            role: "Marketing",
            desc: "Mengelola strategi pemasaran dan pengembangan brand."
        },
        coding: {
            name: "Nama Developer",
            role: "Web Developer",
            desc: "Mengembangkan website dan sistem digital perusahaan."
        }
    };

    document.getElementById("bioName").innerText = data[role].name;
    document.getElementById("bioRole").innerText = data[role].role;
    document.getElementById("bioDesc").innerText = data[role].desc;
